...
//The code below present only the card of the panet we paSS   in the function.

// document.querySelector(".container").innerHTML = createPlanetHTML(planets[0]);
//=====================================================================
// The code below loop throuh the array of planets and join them to display side by side
//
